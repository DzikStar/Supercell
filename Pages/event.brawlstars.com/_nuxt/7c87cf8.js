    ...
    1040: function(e, t, a) {
        ...
        t.default = function(e) {
            return function(t) {
                ...
                if (!u)
                    return null;
                var d, s = u[0], l = i && e.parsePatterns[i] || e.parsePatterns[e.defaultParseWidth], f = Array.isArray(l) ? r(l, (function(e) {
                    return e.test(s)
                }
                )) : n(l, (function(e) {
                    return e.test(s)
                ...
                d = e.valueCallback ? e.valueCallback(f) : f,
    ...
    1335: function(e, t, a) {
        ...
        var n = {
          ...
          , r = function(e, t, a) {
            ...
            null != a && a.addSuffix ? a.comparison && a.comparison > 0 ? "in " + r : r + " ago" : r
        };
        t.default = r,
        e.exports = t.default
    },
